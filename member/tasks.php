      ...
      <div class="row mt-5">
        <div class="col">
            ...
            <div class="card-header bg-info text-white d-flex justify-content-between">
                          <h4 class="font-mali">Task table<?php if (isset($_REQUEST['task_add'])) { echo($_REQUEST["task_add"]=="success") ? " : Add task success." : "";}?></h4>
            ...
            <div class="input-group mr-2">
                <div class="input-group-prepend">
                  ...
                  <input type="text" name="task_id" id="task_id" class="form-control" value="<?php echo $_REQUEST['task_id']?>">
                </div>
              </div>
              ...
              <div class="input-group mr-2">
                <div class="input-group-prepend">
                  ...
                  <input type="text" name="title" id="title" class="form-control" value="<?php echo $_REQUEST['title']?>">
                </div>
              </div>
              <div class="input-group mr-2">
                <div class="input-group-prepend">
                  ...
                  <select name="status"id="status"class="form-control">
                                   ...
                                   <?php if ($_REQUEST['status']=="Waiting") { $wait = "selected";}?>
                                   <?php if ($_REQUEST['status']=="Pending") { $pend = "selected";}?>
                                   <?php if ($_REQUEST['status']=="Complete") { $comp = "selected";}?>
                                   <option value='Waiting' <?php echo($wait); ?> >Waiting</option>
                                   <option value='Pending' <?php echo($pend); ?> >Pending</option>
                                   <option value='Complete' <?php echo($comp); ?> >Complete</option>
                               </select>
                    </div>
              </div>
                          ...
                          <table class="table">
                              ...
                              <tbody>
                                  <?php
                                    ...
                                    $taskObj =  new Task();
                                    $filters = ($_REQUEST+$_SESSION+array_flip(['task_id','title','status']));
